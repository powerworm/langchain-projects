...
def main():
    ...
    information = """Elon Reeve Musk (born June 28, 1971) is a businessman and former public official known for his leadership of Tesla and SpaceX. Musk has been the wealthiest person in the world since 2025; as of June 2026, Forbes estimates his net worth to be US$834 billion.
...
"""
    ...
    summary_template = """
    given the information about a person \"{information}\", I want you to created:
    1. A short summary
